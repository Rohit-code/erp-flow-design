...
const BOOKING_ITEMS: NavItem[] = [
  ...
  { label: 'Booking Acceptance', screen: 'ops-accept',     icon: <I.shield /> },
  { label: 'Bookings',        screen: 'booking-list',      icon: <I.calendar /> },
  { label: 'CRO',             screen: 'cro-release',       icon: <I.doc /> },
  { label: 'Container Tracking', screen: 'container-tracking', icon: <I.list /> },
  { label: 'Gate In',         screen: 'gate-in',           icon: <I.hash /> },
  { label: 'Load Vessel',     screen: 'load-vessel',       icon: <I.flow /> },
