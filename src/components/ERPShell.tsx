...
const BOOKING_ITEMS: NavItem[] = [
  ...
  { label: 'Booking Acceptance', screen: 'ops-accept-list', icon: <I.shield /> },
  { label: 'Bookings',        screen: 'booking-list',      icon: <I.calendar /> },
  { label: 'CRO',             screen: 'cro-list',          icon: <I.doc /> },
  { label: 'Container Tracking', screen: 'container-tracking-list', icon: <I.list /> },
  { label: 'Gate In',         screen: 'gate-in-list',      icon: <I.hash /> },
  { label: 'Load Vessel',     screen: 'load-vessel-list',  icon: <I.flow /> },
  { label: 'BL Draft',        screen: 'bl-draft-list',     icon: <I.doc /> },
  { label: 'Invoice',         screen: 'invoice-list',      icon: <I.creditCard /> },
  { label: 'MBL',             screen: 'mbl-release-list',  icon: <I.doc /> },
